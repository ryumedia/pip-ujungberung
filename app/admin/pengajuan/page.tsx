                      ...
                      <select 
                        ...
                        className={`rounded-md border px-2 py-1 text-sm font-medium focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-zinc-800 
                          ${item.status_pengajuan === 'Sudah SK' ? 'border-purple-200 bg-purple-50 text-purple-700 dark:border-purple-800 dark:bg-purple-900/30 dark:text-purple-400' : 
                            item.status_pengajuan === 'Tidak Terdaftar' ? 'border-blue-200 bg-blue-50 text-blue-700 dark:border-blue-800 dark:bg-blue-900/30 dark:text-blue-400' :
                            ...
                            item.status_pengajuan === 'Diajukan Lain' ? 'border-yellow-200 bg-yellow-50 text-yellow-700 dark:border-yellow-800 dark:bg-yellow-900/30 dark:text-yellow-400' :
                            'border-zinc-200 bg-zinc-50 text-zinc-700 dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-400'}`}
                      >
                        <option value="Menunggu">Menunggu</option>
                        <option value="Diinput">Diinput</option>
                        <option value="Sudah SK">Sudah SK</option>
